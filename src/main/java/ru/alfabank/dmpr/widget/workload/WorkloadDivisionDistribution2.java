...
@Service
public class WorkloadDivisionDistribution2 extends BaseChart<WorkloadOptions>
{
    @Autowired
    ...
    public WorkloadDivisionDistribution2() {
    ...
    public ChartResult[] getData(WorkloadOptions options) {
        ...
        queryOptions.sliceCode = SliceCode.DIRECTION3.toString();
