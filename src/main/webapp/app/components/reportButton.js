app.components.ReportButton = function (params, element) {
    var self = this;

    var groupName = params.group || app.defaultGroupName,
        group = app.viewModel.getGroup(groupName),
        reportUrl = params.reportUrl,
        btnText = params.text || "Выгрузить в Excel",
        btnProcessingText = params.processingText || "Создание документа Excel...";
    ...
    self.generateReport = function () {
        console.log("Generating report by url \"" + reportUrl + "\"...");
        ...
        app.ajaxUtils.postData(reportUrl, requestData).done(function (ajaxResult) {
            ...
            var reportName = ajaxResult.data.reportName,
                    ...
                    reportUrl = app.rootUrl + "excel/getById?id=" + id + "&reportName=" + reportName;
...
ko.components.register("report-button", {});