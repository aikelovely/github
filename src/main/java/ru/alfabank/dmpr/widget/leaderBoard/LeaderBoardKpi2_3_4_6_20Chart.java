 ...
 */
@Service
public class LeaderBoardKpi2_3_4_6_20Chart extends BaseChart<LeaderBoardOptions> {
    @Autowired
    LeaderBoardRepository repository;

    public LeaderBoardKpi2_3_4_6_20Chart() {
    ...
    public ChartResult[] getData(LeaderBoardOptions options) {
        ...
        return LinqWrapper.from(repository.getKpiData(options, "KPIOB~2", "KPIOB~3", "KPIOB~4", "KPIOB~6", "KPIOB~20"))
