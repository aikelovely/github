...
@Service
public class WorkloadDivisionDistribution extends BaseChart<WorkloadOptions>
{
    @Autowired
    ...
    public WorkloadDivisionDistribution() {
    ...
    public ChartResult[] getData(WorkloadOptions options) {
        ...
        queryOptions.sliceCode = SliceCode.DIRECTION2.toString();
